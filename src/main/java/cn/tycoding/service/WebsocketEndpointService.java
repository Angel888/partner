...
//    private static CopyOnWriteArraySet<WebsocketEndpointService> websocketServerEndpoints = new CopyOnWriteArraySet<>();
//
//        private final ChatSessionService chatSessionService;  // ToDo 这里应该得用final吧
//
//
//        //在线连接数
...
//        private static CopyOnWriteArraySet<WebsocketEndpointService> websocketServerEndpoints = new CopyOnWriteArraySet<>();
//        //todo websocketServerEndpoints 有啥用
//        //与客户端的会话Session
...
//            this.session = session;  //todo this指的是WebsocketServerEndpoint吧，里面都有啥东西？
//
//            //将当前websocket对象存入到Set集合中
//            websocketServerEndpoints.add(this); //todo add之后，后面的this.fromId也会带上吧
//
//            //在线人数+1
//            addOnlineCount();
//
...
//                //群发消息
//                Map<String, Object> map = new HashMap<>();  //todo 这里可以改成jwt的校验
